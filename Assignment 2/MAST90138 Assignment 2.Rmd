...
```
By testing the null hypothesis: $q$ is the number of factors for each allowed q, we can see that the p-value returned when $q=4$ is 0.0988, which is greater than the significance level of 0.05, hence we do not reject the null hypothesis and the factor model with $q=4$ has the best fit.
